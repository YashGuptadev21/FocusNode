...
const TaskDetails = () => {
  ...
  return (
    <div className="w-full flex flex-col gap-3 mb-4 overflow-y-hidden">
      <h1 className="text-2xl text-gray-600 font-bold px-2">{task?.title}</h1>
...
const Activities = ({ activity, id, ref }) => {
    ...
    return (
      <div className="flex space-x-4">
        ...
        <div className="flex flex-col gap-y-1 mb-8">
          <p className="font-bold">{item?.by?.name}</p>
          <div className="text-gray-500 space-y-2">
            <span className="capitalize mr-1">{item?.type}</span>
            <span className="text-md">{moment(item?.date).fromNow()}</span>
          </div>
