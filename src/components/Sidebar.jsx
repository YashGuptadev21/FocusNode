...
const Sidebar = () => {
  ...
  const NavLink = ({ el }) => {
    return (
      <Link
        ...
        className={clsx(
          "w-full lg:3/4 flex gap-2 px-3 py-2 rounded-full items-center text-gray-800 text-base hover:bg-[#2564ed2d]",
          path === el.link ? "bg-blue-700 text-neutral-1000" : ""
        )}
      >
        {el.icon}
  ...
  return (
    <div className="w-full h-full flex flex-col gap-6 p-5">
      ...
      <div className="">
        <button className="w-full flex gap-2 p-2 items-center text-lg texy-gray-800">
            <MdSettings />
            <span>Settings</span>
        </button>
      </div>
